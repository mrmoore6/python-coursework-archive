...
df = pd.read_csv('2490847.csv', sep=',')

new_df = df.drop(["STATION","CDSD","DSND","DSNW","EMNT","EMSD","EMSN","EMXP","EMXT","HDSD","TAVG","TMAX","TMIN"], axis=1)
...
axs[1].set_title("2021-01 Rain Totals Iowa")

axs[2].plot(new_dates_snow['SNOW'],color='b')
axs[2].xaxis.set_visible(False)
axs[2].set_title("2021-02 Snow Totals Iowa")

axs[3].plot(new_dates_rain['PRCP'],color='g')
axs[3].xaxis.set_visible(False)
axs[3].set_title("2021-02 Rain Totals Iowa")
